...
public class Main {
	...
	public static boolean ejecutaComando(){
		...
		System.out.println("10 -> Añadir un usuario");
		System.out.println("11 -> Añadir un cine");
		System.out.println("12 -> Conocer qué usuarios han visto una película o episodio");
		System.out.println("13 -> Consultar las películas y episodios vistos por un usuario ");
		System.out.println("14 -> Ver las valoraciones realizadas por un usuario");
		System.out.println("15 -> Ver aquellas valoraciones muy negativas (puntuación inferior a 4) de un usuario");
		System.out.println("16 -> Ver aquellas valoraciones muy negativas (puntuación inferior a 4) de una película");
		System.out.println("17 -> Consultar la cartelera de un cine dado su nombre");
		System.out.println("18 -> Consultar las películas (solo su título) que han sido vistas por algún usuario en un cine concreto");
		System.out.println("19 -> Obtener los cines en los que un usuario (dado su nombre) ha visto películas");
		System.out.println("20 -> Obtener los usuarios que han visto alguna película en un cine concreto");
		...
		case "9":
			...
			case "12":
				System.out.println("Introcude 1 si quieres película, 2 si quieres episodio, 0 cancela.");
				boolean seguir = true;
				String opcion = "";
				String tituloP = "";
	...
	public static void rellenaBaseDatos(){
		...
		DBHelper.insertaEpisodio(episodio,
				DBHelper.dataBase.getCampo("_id", Constantes.TEMPORADAS, temporada).toString());// Lista vacía de valoraciones, no hay valoraciones.
